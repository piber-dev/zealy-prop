...
We are going to start a sprint for March sometime between the 1st and 3rd of March under the assumption that the proposal is going to pass, but if it does not we will quickly end it and pay out rewards from the small amount of left-over funds. A new wallet will be used to manage Zealy funds.
